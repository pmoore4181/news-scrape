...
$(document).ready(function() {
  ...
  $(document).on("click", ".theSave", handleArticleSave);
  $(".theScraper").on("click", handleArticleScrape);
  ...
  function renderArticles(articles) {
    ...
    resultsContainer.append(articlePanels);
  }
  ...
  function renderEmpty() {
    ...
    var emptyAlert = $(
      [
        ...
        "<h4><a class='theScraper'>Try Scraping New Articles</a></h4>",
    ...
    resultsContainer.append(emptyAlert);
  }
